...
$(document).ready(function() {
	...
	/* $('th.lines').unbind('click');
	$('th.lines>div .DataTables_sort_icon').remove(); */
...
function loadDataTable(this_datatables) {
	return $(this_datatables).dataTable({
		...
		colVis: {
            ...
            showAll: button_all_see,
            "buttonText": button_column,
            /* order: 'alpha', */
            activate: "mouseover"
        },
        ...
        "oTableTools": {
	    	"aButtons": aButtons,
	        "sSwfPath": base_url+"assets/grocery_crud/themes/gesauth/extras/TableTools/media/swf/copy_csv_xls_pdf.swf"
	    }
