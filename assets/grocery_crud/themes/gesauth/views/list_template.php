<?php
	...
	$this->set_css($this->default_theme_path.'/gesauth/css/demo_table_jui.css');
	$this->set_css($this->default_css_path.'/ui/simple/'.grocery_CRUD::JQUERY_UI_CSS);
	$this->set_css($this->default_theme_path.'/gesauth/css/gesauth.css');
	$this->set_css($this->default_theme_path.'/gesauth/css/jquery.gesauth.css');
	$this->set_css($this->default_theme_path.'/gesauth/css/gesauth.colReorder.min.css');
	$this->set_css($this->default_theme_path.'/gesauth/css/gesauth.colVis.min.css');
	$this->set_css($this->default_theme_path.'/gesauth/css/gesauth.colvis.jqueryui.css');
	$this->set_css($this->default_theme_path.'/gesauth/extras/TableTools/media/css/TableTools.css');
	...
	$this->set_js_lib($this->default_theme_path.'/gesauth/js/jquery.gesauth.js');
	$this->set_js_lib($this->default_theme_path.'/gesauth/js/gesauth.colReorder.min.js');
	$this->set_js_lib($this->default_theme_path.'/gesauth/js/gesauth.colVis.min.js');
	$this->set_js_lib($this->default_theme_path.'/gesauth/js/gesauth.fixedHeader.min.js');
	$this->set_js_lib($this->default_theme_path.'/gesauth/js/gesauth.fixedColumns.min.js');
	$this->set_js_lib($this->default_theme_path.'/gesauth/js/jquery.jeditable.js');
	$this->set_js($this->default_theme_path.'/gesauth/js/gesauth-extras.js');
	$this->set_js($this->default_theme_path.'/gesauth/js/gesauth.js');
	$this->set_js($this->default_theme_path.'/gesauth/extras/TableTools/media/js/ZeroClipboard.js');
	$this->set_js($this->default_theme_path.'/gesauth/extras/TableTools/media/js/TableTools.min.js');
...
<script type='text/javascript'>
	...
	var copy_text = '<?php echo $this->l('list_copy');?>';
	var print_text = '<?php echo $this->l('list_print');?>';
	var button_all_see = '<?php echo $this->l('list_all_see');?>';
	var button_restore = '<?php echo $this->l('list_restore');?>';
	var button_column = '<?php echo $this->l('list_columns');?>';
...
<?php }?>
<h3><?php echo $this->l('list_title'); ?> <?php echo $subject?></h3>
...
<script src="<?php echo site_url().$this->default_theme_path; ?>/gesauth/js/gesauth-list.js"></script>