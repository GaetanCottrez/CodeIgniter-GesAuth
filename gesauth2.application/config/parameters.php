...
/**
 * Custom Constant for example Gesauth
 *
...
define('ACTIVATE_PROFILTER', TRUE);
define('VERSIONING_FILES', '1.0');
define('PREFIX','gesauth_');
define('URI_LOGIN','login');
define('URI_LOGOUT','logout');
define('URI_CLOSE_BROWSER','ajax_close_browser');
define('VERSION','1.0');
